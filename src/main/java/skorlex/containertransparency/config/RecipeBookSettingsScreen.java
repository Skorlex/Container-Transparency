...
public class RecipeBookSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        OptionInstance<Double> searchOption = new OptionInstance<>("options.container-transparency.recipe_book.search", OptionInstance.cachedConstantTooltip(Component.translatable("options.container-transparency.recipe_book.search.tooltip")), this::formatValue, OptionInstance.UnitDouble.INSTANCE, (double) ContainerTransparencyConfig.recipeBookSearchOpacity, value -> { ContainerTransparencyConfig.recipeBookSearchOpacity = value.floatValue(); ContainerTransparencyConfig.save(); });
        ...
        this.addRenderableWidget(searchOption.createButton(this.minecraft.options, centerX, startY + (spacing * 2), buttonWidth));
